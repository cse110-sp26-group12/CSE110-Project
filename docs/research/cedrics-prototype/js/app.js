...
function setupEventListeners() {
  // Navigation
  ui.elements.navButtons.dashboard.addEventListener('click', () =>
    ui.switchView('dashboard'),
  );
  ui.elements.navButtons.roster.addEventListener('click', () =>
    ui.switchView('roster'),
  );
  ui.elements.navButtons.warroom.addEventListener('click', () =>
    ui.switchView('warroom'),
  );
  ui.elements.navButtons.checkin.addEventListener('click', () =>
    ui.switchView('checkin'),
  );
